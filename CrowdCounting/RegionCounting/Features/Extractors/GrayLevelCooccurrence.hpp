#ifndef GRAYLEVELCOOCCURRENCE_HPP
#define GRAYLEVELCOOCCURRENCE_HPP
...
class GrayLevelCooccurrence : public FeatureExtractor
{
public:
    ...
    CVX_CLONE_IN_DERIVED(GrayLevelCooccurrence)
    CVX_CONFIG_DERIVED(GrayLevelCooccurrence)
};

}

#endif // GRAYLEVELCOOCCURRENCE_HPP
