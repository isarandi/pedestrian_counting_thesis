...
namespace Etiseo {
 ...
 class CameraModel
 {
    public:
      ...
      bool undistortedToDistortedImageCoord (double Xfu, double Yfu, double& Xfd, double& Yfd) const;
	  //! convert from distorted to undistorted image
      bool distortedToUndistortedImageCoord (double Xfd, double Yfd, double& Xfu, double& Yfu) const;
	  
	  //! from world coordinate to camera coordinate
      bool worldToCameraCoord (double xw, double yw, double zw, double& xc, double& yc, double& zc) const;
	  //! from camera coordinate to world coordinate
      bool cameraToWorldCoord (double xc, double yc, double zc, double& xw, double& yw, double& zw) const;
