...
bool CameraModel::undistortedToDistortedImageCoord (double Xfu, double Yfu, double& Xfd, double& Yfd) const
{
	bool done = false;
	double Xu;
	double Yu;
...
bool CameraModel::distortedToUndistortedImageCoord (double Xfd, double Yfd, double& Xfu, double& Yfu) const
{
	bool done = false;
	double Xd;
	double Yd;
...
bool CameraModel::worldToCameraCoord (double xw, double yw, double zw, double& xc, double& yc, double& zc) const
{
	bool done = false;
...
bool CameraModel::cameraToWorldCoord (double xc, double yc, double zc, double& xw, double& yw, double& zw) const
{
	bool done = false;
	double common_denominator;
